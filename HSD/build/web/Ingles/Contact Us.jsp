...
<form>
  <div class="form-row" style="margin: 0px 200px">
    <div class="form-group col-md-6">
      ...
      <input type="email" class="form-control" id="inputEmail4" placeholder="You name">
    </div>
    ...
    <div class="form-group col-md-6">
      ...
      <input maxlength="10" class="form-control" id="inputPassword4" placeholder="Id">
    </div>
  </div>
  ...
  <div class="form-row" style="margin: 0px 200px">
    ...
    <div class="form-group col-md-6">
      ...
      <input type="text" maxlength="10" class="form-control" id="inputZip">
    </div>
  </div>

  <div class="form-group" style="margin: 0px 200px">
    <label for="exampleFormControlTextarea1">Leave us a comment!</label>
    <textarea class="form-control" id="exampleFormControlTextarea1" rows="3"></textarea>
  </div>

  <center>
  <button type="submit" class="btn btn-primary" style="margin: 50px 200px" >Submit</button>
  </center>
</form>
