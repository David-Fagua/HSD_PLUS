                        ...
                        <ul class="nav nav-second-level">
                            <li>
                                <a href="ControladorregistroReservas?accion=listar">
                                    <i class="menu-icon fa fa-caret-right"></i>Registro Reservas</a>
                            </li>
                        </ul>
                    </li>
                    <li>
                        ...
                        <ul class="nav nav-second-level">
                            <li>
                                <a href="ControladorregistroRegistro_ventas?accion=listar">
                                    <i class="menu-icon fa fa-caret-right"></i>Registro Ventas</a>
                            </li>
                        </ul>
                    </li>
                    <li>
                        ...
                        <ul class="nav nav-second-level">
                            <li>
                                <a href="ControladorUsuarios?accion=listar">
                                    <i class="menu-icon fa fa-caret-right"></i>Usuarios</a>
                            </li>
                            <li>
                                <a href="ControladorInventario_general?accion=listar">
                                    <i class="menu-icon fa fa-caret-right"></i>Inventario General</a>
                            </li>
                            <li>
                                <a href="ControladorProducto_proceso?accion=listar">
                                    <i class="menu-icon fa fa-caret-right"></i>Producto en Proceso</a>
                            </li>                            
                            <li>
                                <a href="ControladorProducto_final?accion=listar">
                                    <i class="menu-icon fa fa-caret-right"></i>Producto Final</a>
                            </li>
                            <li>
                                <a href="ControladorSobrantes?accion=listar">
                                    <i class="menu-icon fa fa-caret-right"></i>Sobrantes</a>
                            </li>
                            <li>
                                <a href="ControladorDesechos?accion=listar">
                                    <i class="menu-icon fa fa-caret-right"></i>Desechos</a>
                            </li>
                        </ul>
                    </li>
                    <li>
                        <a href="#" class="dropdown-toggle">
                            ...
                            <span class="menu-text">Componentes<span class="fa arrow"></span></a>
                        <ul class="nav nav-second-level">
                            <li>
                                <a href="ControladorTipo_documento?accion=listar"><i class="menu-icon fa fa-caret-right"></i>Tipo Documento</a>
                            </li>
                            <li>
                                <a href="ControladorRoles?accion=listar">
                                    <i class="menu-icon fa fa-caret-right"></i>Registrar Rol</a>
                            </li>
                            <li>
                                <a href="ControladorProveedor?accion=listar">
                                    <i class="menu-icon fa fa-caret-right"></i>Registrar Proveedor</a>
                            </li>
                            <li>
                                <a  href="ControladorGrosor_hilo?accion=listar">
                                    <i class="menu-icon fa fa-caret-right"></i>Registrar Grosor de hilo</a>
                            </li>
                            <li>
                                <a href="ControladorCiudad?accion=listar"><i class="menu-icon fa fa-caret-right"></i>Lista de Ciudades</a>
                            </li>
                        </ul>
                    </li>
                ...
                <div class="page-content">
                        ...
                        <div class="container">
                            <form action="ControladorCiudad">
                                ...
                                <input class="btn btn-primary  btn-sm  " type="submit" name="accion" value="Agregar">
                                <a class="btn btn-default btn-sm" href="ControladorCiudad?accion=listar">Regresar</a>
                            </form>
                        </div>
