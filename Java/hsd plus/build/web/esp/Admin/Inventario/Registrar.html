...
<div id="page-wrapper">
        <div class="container-fluid">
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">Registrar nuevo producto</h1>
                   <div class="card mb-3">
</div>
    ...
    <div class="col-md-8">
      ...
      <div class="form-group"> <!-- Vendedor Button -->
        <label for="state_id" class="control-label" >Vendedor</label>
        <select class="form-control" id="state_id">
            <option value="AL">Algodones S.A</option>
            <option value="AK">Parisina</option>
            <option value="AZ">Quiminet</option>
        </select>                    
      </div>
      ...
      <div class="form-group">
         <input type="text" class="form-control" placeholder="Apellido vendedor">
      </div>
      <div class="form-group">
  ...
  <div class="row ">
    <br>
            <div class="col-md-6 col-sm-6 col-xs-6 pad-adjust">
                 <input type="submit"  class="btn btn-default"value="Cancelar"/> &nbsp; &nbsp; &nbsp;<input type="submit"  class="btn btn-primary" value="Registrar"/>
              </div>
