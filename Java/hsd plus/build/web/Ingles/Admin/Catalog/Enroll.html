...
<head>
    ...
    <title>Register in Catalog</title>
    ...
    <div class="container-fluid">
        <div class="col-lg-12">
            <div class="row">
                ...
                <div class="col-md-12">
                    <h1 class="page-header">Register in Catalog</h1>
                    <center>
                    ...
                    <a href="../../../../Error 404.html" style="float:center;" class="btn btn-primary btn-lg" role="button">Save</a>
                </form>
            </div>
        </div>
    </div>
