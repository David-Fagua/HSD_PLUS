...
<div class="container">
  <div class="row featurette">
    <div class="col-md-8 order-md-2">
      ...
      <p class="lead">HSD PLUS, es una Startup seria, moderna con unos excelentes profesionales que permanecen siempre investigando, innovando y mejorando para entregar los mejores servicios tecnolÃ³gicos de desarrollo de alta calidad a nuestros clientes. Brindando interfases cÃ³modas, afiles y fÃ¡ciles de usar para mayor productividad en las actividades que desempeÃ±en nuestros clientes.</p>
    </div>
