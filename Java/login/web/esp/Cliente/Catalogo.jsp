...
<div class="container">
  <div class="row featurette">
    <div class="col-md-6 order-md-2">
      ...
      <h6 href="producto.html" class="lead">este tipo de hilo sirve para cualquier tipo de costura pero es muy aconsejado para coser a mano, ya que es suave y fácil de sacar y romper.</h6>
      <div class="col-6 col-md">
      <a href="producto.html" class="badge badge-info">Destacado</a>
    </div>
  </div>
  <div class="col-md-2 order-md-4">
    <h3 class="text-right" class="featurette-heading">$8.000</h3>
    <a href="producto.html" style="float:right;" class="btn btn-primary btn-lg" role="button">Ver Más.</a>
  </div>
  ...
  <div class="row featurette">
    <div class="col-md-6 order-md-2">
      ...
      <h6 href="producto.html" class="lead"> usado para coser seda y otras telas delicadas ofrece una variedad cromática muy limitada. Ideal para bordados. Su precio es más elevado que el resto.</h6>
      <div class="col-6 col-md">
      <a href="producto.html" class="badge badge-info">Destacado</a>
    </div>
  </div>
  ...
  <div class="row featurette">
    <div class="col-md-6 order-md-2">
      ...
      <h6 href="producto.html" class="lead">elásticos y por norma general fabricados con poliéster. Existen modelos también de algodón y fibra sintética. Este tipo es de los más resistentes para todo tipo de telas.</h6>
      <div class="col-6 col-md">
      <a href="producto.html" class="badge badge-info">Destacado</a>
    </div>
  </div>
  ...
  <div class="row featurette">
    <div class="col-md-6 order-md-2">
      ...
      <h6 href="producto.html" class="lead">este tipo de hilo es ideal para coser lana, algodón y tiene un tono brillante. Sirven para coser tanto a máquina como a mano. Este tipo de hilo es mucho más resistente a los lavados y planchados.</h6>
      <div class="col-6 col-md">
      <a href="producto.html" class="badge badge-info">Destacado</a>
    </div>
  </div>
  ...
  <div class="row featurette">
    <div class="col-md-6 order-md-2">
      ...
      <h6 href="producto.html" class="lead">Hilo de alta calidad para limpiar los dientes.</h6>
      <div class="col-6 col-md">
      <a href="producto.html" class="badge badge-info">Destacado</a>
    </div>
  </div>
