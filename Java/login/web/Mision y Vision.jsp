...
<div class="container">
  <div class="row featurette">
    <div class="col-md-7">
      <h2 class="featurette-heading">Misi贸n</h2>
      <p class="lead">Somos una empresa dedicada a la comercializaci贸n y distribuci贸n de productos inform谩ticos, fabricaci贸n de ordenadores, desarrollo de aplicaciones inform谩ticas de gesti贸n, soluciones en Internet, servicio t茅cnico y mantenimiento de equipos y sistemas inform谩ticos, hosting, y consultor铆a de protecci贸n de datos. Ofreciendo una soluci贸n a todo el territorio nacional.</p>
    </div>
    <div class="col-md-5">
  ...
  <div class="row featurette">
    <div class="col-md-7 order-md-2">
      <h2 class="featurette-heading">Visi贸n</h2>
      <p class="lead">Pretendemos ser un referente en el mercado nacional en el sector de las TIC, y para ello abarcaremos todos los servicios que ofrecemos actualmente incrementando los que vayan surgiendo debido a la necesidad de cambio provocado por los avances tecnol贸gicos. Esto es as铆 ya que somos una empresa en constante innovaci贸n ya que el sector de la tecnolog铆a as铆 lo requiere.</p>
    </div>
