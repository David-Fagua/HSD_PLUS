  ...
  <div class="row">
    ...
    <div class="col-md-4 order-md-2 mb-4">
      <h4 class="d-flex justify-content-between align-items-center mb-3">
        <span class="text-muted">Carrito de Reservas</span>
...
<h2 class="featurette-heading">Hilo X</h2>
        ...
        <a href="Reservar.html" style="float:right;" class="btn btn-primary btn-lg" role="button">Añadir al Carrito</a>
        <a href="Reservar.html" style="float:right;" class="btn btn-primary btn-lg" role="button">Ver mas productos</a>
      </div>
    </div>
  </div>
</div>
