							...
							<h1>
								Tabla Roles
                                                ...
                                                <div class="container">
                                                    ...
                                                    <a class="btn btn-primary  btn-sm  " href="ControladorRoles?accion=add">Agregar Rol</a>
                                                    ...
                                                    <div>
                                                        <table id="dynamic-table" class="table table-striped table-bordered table-hover">
                                                            <thead class="text-center">
                                                                <tr>
                                                                    <th class="text-center hidden-400">ID Rol</th>
                                                                    <th class="text-center hidden-400">Nombre</th>
                                                                    <th class="text-center hidden-400">Fecha de Apertura</th>
                                                            ...
                                                            <tbody>
                                                                <tr>
                                                                    <td class="text-center"><%= rrl.getId_rol()%></td>
                                                                    <td class="text-center"><%= rrl.getNombre()%></td>
                                                                    <td class="text-center"><%= rrl.getFecha_apertura()%></td>
                                                                    <td class="text-center">
                                                                        <a class="btn btn-warning ace-icon fa fa-pencil btn-xs bigger" href="ControladorRoles?accion=editar&id_rol=<%= rrl.getId_rol()%>">Editar</a>
                                                                        <a class="btn btn-danger ace-icon fa fa-trash-o btn-xs bigger" href="ControladorRoles?accion=eliminar&id_rol=<%= rrl.getId_rol()%>">Remover</a>
                                                                    </td>
                                                                </tr>
                                                                <%}%>
                                                            </tbody>
