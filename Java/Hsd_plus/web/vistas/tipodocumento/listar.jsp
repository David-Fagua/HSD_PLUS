								...
								TABLA DE TIPOS DE DOCUMENTO
                                                ...
                                                <div class="container">
                                                    ...
                                                    <div>
                                                        ...
                                                        <a class="btn btn-primary  btn-sm  "href="ControladorTipo_documento?accion=add">Agregar Nuevo Registro</a><br><br>
                                                        <table id="dynamic-table" class="table table-striped table-bordered table-hover">
                                                            <thead>
                                                                <tr class="text-center">
                                                                    <th class="text-center">ID TIPO DE DOCUMENTO</th>
                                                                    <th class="text-center">ABREBIATURA</th>
                                                            ...
                                                            <tbody>
                                                                <tr>
                                                                    <td class="text-center"><%= tid.getId_tdocumento()%></td>
                                                                    <td class="text-center"><%= tid.getAbrebiatura()%></td>
                                                                    <td class="text-center"><%= tid.getNombre()%></td>
                                                                    <td class="text-center">
                                                                        <a class="btn btn-warning ace-icon fa fa-pencil btn-xs bigger" href="ControladorTipo_documento?accion=editar&id_tdocumento=<%= tid.getId_tdocumento()%>"> Editar</a>
                                                                        <a class="btn btn-danger ace-icon fa fa-trash-o btn-xs bigger" btn btn-primary  btn-sm href="ControladorTipo_documento?accion=eliminar&id_tdocumento=<%= tid.getId_tdocumento()%>">Remove</a>
                                                                    </td>
                                                                </tr>
                                                                <%}%>
                                                            </tbody>
