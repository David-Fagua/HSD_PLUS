<%-- 
    Document   : index
    Created on : 27/11/2019, 08:02:11 PM
    Author     : SAM
--%>
			...
			<div id="sidebar" class="sidebar                  responsive                    ace-save-state">
				...
				<ul class="nav nav-list">
					...
					<li class="active">
						...
						<ul class="submenu">
							<li class="active">
								<a href="ControladorTipo_documento?accion=listar">Tipo Documento</a><br>
							...
							<li class="">
								...
								<b class="arrow"></b>
                                                        ...
                                                        <li class="">
								<a href="Controlador?accion=listar">Listar Ciudad</a><br>
