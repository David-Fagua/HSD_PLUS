								...
								<div class="row">
									<div class="col-xs-12">
										...
										<!-- div.dataTables_borderWrap -->
                                                                                <div>
                                                                                    <form action="CiudadControl" method="post" class="form-horizontal">
                                                                                        <div class="form-group">
                                                                                            <label class="col-sm-3 control-label no-padding-right">
                                                                                                Id Ciudad:
                                                                                            </label>
                                                                                            <div class="col-sm-9">
                                                                                                <input type="text" name="id_ciudad" value="" placeholder="ID Ciudad" />
                                                                                            </div>
                                                                                        </div>
                                                                                        ...
                                                                                        <div class="form-group">
                                                                                            ...
                                                                                            <div class="col-sm-9">
                                                                                                <input type="text" name="nombre" value="" placeholder="Nombre Ciudad" />
                                                                                            </div>
                                                                                        </div>
                                                                                        <button name="accion"class="btn btn-success" type="submit" value="accion">
                                                                                            <i class="fa fa-save"></i>
                                                                                            Registrar
                                                                                        </button>
                                                                                        <button name="accion" class="btn btn-warning" type="submit" value="accion">
                                                                                            <i class="fa fa-edit"></i>
                                                                                            Actualizar
                                                                                        </button>
                                                                                        <button name="accion" class="btn btn-danger" type="submit" value="accion">
