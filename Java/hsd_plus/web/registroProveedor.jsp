								...
								<div class="row">
									<div class="col-xs-12">
										...
										<!-- div.dataTables_borderWrap -->
                                                                                <div>
                                                                                    <form action="ProveedorControl" method="post" class="form-horizontal">
                                                                                        ...
                                                                                        <div class="form-group">
                                                                                            ...
                                                                                            <div class="col-sm-9">
                                                                                                <input type="text" name="razon_social" value="" placeholder="Nombre Empresa" />
                                                                                            </div>
                                                                                        </div>
                                                                                        ...
                                                                                        <div class="form-group">
                                                                                            ...
                                                                                            <div class="col-sm-9">
                                                                                                <input type="text" name="direccion" value="" placeholder="Direcion residencia" />
                                                                                            </div>
                                                                                        </div>
                                                                                        ...
                                                                                        <div class="form-group">
                                                                                            ...
                                                                                            <div class="col-sm-9">
                                                                                                <select name="ciudad">
                                                                                                    ...
                                                                                                    <% for(Ciudad ciu:CiudadDao.listar()) { %>
                                                                                                    <option value="<%= ciu.getId_ciudad() %>"><%= ciu.getNombre()%></option>
                                                                                                    <%}%>
                                                                                                </select>
                                                                                            </div>
                                                                                        </div>
