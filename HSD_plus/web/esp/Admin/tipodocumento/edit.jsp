								...
								<!-- /.row -->
                                                                <div>
                                                                    ...
                                                                    <form action="ControladorTipo_documento">
                                                                        Abrebiatura:<br>
                                                                        <input type="text" name="txtabrebiatura" value="<%= td.getAbrebiatura()%>" ><br><br>
                                                                        Nombre:<br>
                                                                        ...
                                                                        <a class="btn btn-default btn-sm" href="ControladorTipo_documento?accion=listar">Regresar</a>
