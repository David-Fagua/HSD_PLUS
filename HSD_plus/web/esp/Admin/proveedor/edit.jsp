								...
								Editar Proveedor
                                                ...
                                                <div>
                                                    <%
                                                        ...
                                                        int id_empresa = Integer.parseInt((String) request.getAttribute("idpro"));
                                                        Proveedor pv = (Proveedor) dao.list(id_empresa);
                                                    %>
                                                    
                                                    <form action="ControladorProveedor">
                                                        Nit: <br>
                                                        <input type="text" name="txtnit" value="<%= pv.getNit() %>"><br>
                                                        Razon Social:<br>
                                                        <input type="text" name="txtrazon_social" value="<%= pv.getRazon_social() %>"><br>
                                                        Telefono:<br>
                                                        <input type="text" name="txttelefono" value="<%= pv.getTelefono() %>"><br>
                                                        Email:<br>
                                                        <input type="text" name="txtemail" value="<%= pv.getEmail() %>"><br>
                                                        Dirección:<br>
                                                        <input type="text" name="txtdireccion" value="<%= pv.getDireccion() %>"><br>
                                                        Ciudad:<br>
                                                        <input type="text" name="txtciudad" value="<%= pv.getCiudad() %>"><br>

                                                        <input type="hidden" name="txtid_empresa" value="<%= pv.getId_empresa()%>"><br>
                                                        <input class="btn btn-primary btn-sm" type="submit" name="accion" value="Actualizar"> 
                                                        <a class="btn btn-default btn-sm" href="ControladorProveedor?accion=listar">Regresar</a>
                                                    </form>
                                                </div>
