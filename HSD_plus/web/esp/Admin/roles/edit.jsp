								...
								Editar Rol
                                                ...
                                                <div>
                                                    <%
                                                        ...
                                                        int id_rol = Integer.parseInt((String) request.getAttribute("idrol"));
                                                        Roles r = (Roles) dao.list(id_rol);
                                                    %>
                                                    
                                                    <form action="ControladorRoles">
                                                        Nombre:<br>
                                                        <input type="text" name="txtnombre" value="<%= r.getNombre()%>"><br><br>
                                                        Fecha de Apertura:<br>
                                                        <input type="text" name="txtfecha_apertura" value="<%= r.getFecha_apertura()%>"><br>
                                                        <input type="hidden" name="txtid_rol" value="<%= r.getId_rol()%>"><br>
                                                        <input class="btn btn-primary btn-sm" type="submit" name="accion" value="Actualizar"> 
                                                        <a class="btn btn-default btn-sm" href="ControladorRoles?accion=listar">Regresar</a>
                                                    </form>
                                                </div>
