...
<div id="page-wrapper">
    <div class="container-fluid">
        <div class="row">
            <div class="col-lg-12">
                <h1 class="page-header">Añadir producto
                </h1>
            </div>
        </div>
 <form class="needs-validation" novalidate>
  <div class="form-row">
    <div class="col-md-2 mb-3">
      ...
      <input type="text" class="form-control" id="validationCustom01" placeholder="Id" maxlength="6">
      <div class="valid-feedback">
      </div>
    </div>
    <div class="col-md-5 mb-3">
      <label for="validationCustom02">Producto</label>
      <input type="text" class="form-control" id="validationCustom02" placeholder="Producto">
      <div class="valid-feedback">
      </div>
    </div>
    <div class="col-md-5 mb-3">
      ...
      <div class="input-group">
        ...
        <input type="date" class="form-control" id="validationCustomUsername" placeholder="Fecha" aria-describedby="inputGroupPrepend" required>
  ...
  <div class="form-row">
    <div class="col-md-4 mb-3">
      ...
      <select id="inputState" class="form-control">
        <option selected>Elige el proveedor...</option>
        <option>Proveedor N1</option>
        <option>Proveedor N2</option>
        <option>Proveedor N3</option>
        <option>Proveedor N4</option>
        <option>Proveedor N5</option>
      </select>
      </div>
    </div>
    <div class="col-md-4 mb-3">
      <label for="validationCustom04">Cantidad</label>
      <input type="number" class="form-control" id="validationCustom04" placeholder="Cantidad" required>
      <div class="invalid-feedback">
     
      </div>
    </div>
    <div class="col-md-4 mb-3">
      <label for="validationCustom05">Precio de compra</label>
      <input type="number" class="form-control" id="validationCustom05" placeholder="Precio de compra" required>
      <div class="invalid-feedback">
