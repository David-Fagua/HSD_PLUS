...
<div class="row">
    ...
    <div class="col-md-6">
      ...
      <div class="myform-bottom">
        <form role="form" action="./Admin/start.html" method="post" class="" onsubmit="return validarInicio()">
          <div class="form-group">
            <input type="text" name="form-username" placeholder="username" class="form-control" id="user-username">
          </div>
          <div class="form-group">
          ...
          <div class="text-center">
            <a href="../404.html">Remember password</a>
          </div>
          <br/>

        <center>
          <button style="float:center;" class="btn btn-primary btn-lg" role="button" type="submit" class="mybtn">Log in</button>
        </center> 
    </form>
  </div>
</div>
