								...
								Editar Grosor Hilo
                                                ...
                                                <div>
                                                    <%
                                                        ...
                                                        int id_ciudad = Integer.parseInt((String) request.getAttribute("idgro"));
                                                        Grosor_hilo gr = (Grosor_hilo) dao.list(id_ciudad);
                                                    %>
                                                    
                                                    <form action="ControladorGrosor_hilo">
                                                        Medida:<br>
                                                        <input type="text" name="txtmedida" value="<%= gr.getMedida()%>"><br>
                                                        
                                                        Fecha Aprobación:<br>
                                                        <input type="date" name="txtfecha_aprobacion" value="<%= gr.getFecha_aprobacion()%>"><br>

                                                        <input type="hidden" name="txtid_grosor" value="<%= gr.getId_grosor()%>"><br>
                                                        <input class="btn btn-primary btn-sm" type="submit" name="accion" value="Actualizar"> 
                                                        <a class="btn btn-default btn-sm" href="ControladorGrosor_hilo?accion=listar">Regresar</a>
                                                    </form>
                                                </div>
