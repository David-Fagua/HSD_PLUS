  ...
  <nav class="navbar navbar-expand-lg fixed-top navbar-light bg-light">
   ...
   <button class="navbar-toggler" type="button" data-toggle="collapse" data-target="#navbarSupportedContent" aria-controls="navbarSupportedContent" aria-expanded="false" aria-label="Toggle navigation">
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
      ...
      <span><a style="float:left;" href="Ingles/Start.htm">Ingles</a></span>
...
<div class="container">
  <div class="row featurette">
    <div class="col-md-6 order-md-2">
      ...
      <h6 href="Productos.htm" class="lead">Este tipo de hilo sirve para cualquier tipo de costura pero es muy aconsejado para coser a mano, ya que es suave y fácil de sacar y romper.</h6>
  ...
  <div class="row featurette">
    <div class="col-md-6 order-md-2">
      ...
      <h6 href="Productos.htm" class="lead">Usado para coser seda y otras telas delicadas ofrece una variedad cromática muy limitada. Ideal para bordados. Su precio es más elevado que el resto.</h6>
      <div class="col-6 col-md">
      <a href="#" class="badge badge-info">Destacado</a>
    </div>
  </div>
  ...
  <div class="row featurette">
    <div class="col-md-6 order-md-2">
      ...
      <h6 href="Productos.htm" class="lead">Elásticos y por norma general fabricados con poliéster. Existen modelos también de algodón y fibra sintética. Este tipo es de los más resistentes para todo tipo de telas.</h6>
      <div class="col-6 col-md">
      <a href="#" class="badge badge-info">Destacado</a>
    </div>
  </div>
  ...
  <div class="row featurette">
    <div class="col-md-6 order-md-2">
      ...
      <h6 href="Productos.htm" class="lead">Este tipo de hilo es ideal para coser lana, algodón y tiene un tono brillante. Sirven para coser tanto a máquina como a mano. Este tipo de hilo es mucho más resistente a los lavados y planchados.</h6>
      <div class="col-6 col-md">
      <a href="#" class="badge badge-info">Destacado</a>
    </div>
  </div>
  ...
  <div class="row featurette">
    <div class="col-md-6 order-md-2">
      ...
      <h6 href="Productos.htm" class="lead">Hilo de alta calidad para limpiar los dientes.</h6>
      <div class="col-6 col-md">
      <a href="#" class="badge badge-info">Destacado</a>
    </div>
  </div>
