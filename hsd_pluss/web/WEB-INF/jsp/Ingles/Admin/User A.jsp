...
<div id="page-wrapper">
    <div class="container-fluid">
        <div class="row featurette">
            <div class="col-md-8">
                <h1 class="featurette-heading">Samuel Sanchez</h1>
                <h2 class="featurette-heading">Admin</h2>
                <p class="lead">Expert administrator in attention to lawyers, 24 hours a day, 7 days a week. We provide the highest quality threads to the whole country. </p>
                 <to href="Usuario.html" class="btn btn-info">Ver Más.</a>
            </div>
            <div class="col-md-4">
                <img src="../../img/22.jpg" width="300" height="300" class="card-img-top">
            </div>
        </div>
        </br>
        <div class="row featurette">
            <div class="col-md-8">
                ...
                <h2 class="featurette-heading">Secretary</h2>
                <p class="lead">Expert administrator in attention to lawyers, 24 hours a day, 7 days a week. We provide the highest quality threads to the whole country.
        ...
        <div class="row featurette">
            <div class="col-md-8">
                <h1 class="featurette-heading">Harold Manotas</h1>
                <h2 class="featurette-heading">Client</h2>
                <p class="lead">Expert administrator in attention to lawyers, 24 hours a day, 7 days a week. We provide the highest quality threads to the whole country.</p>
                <a href="Usuario.html" class="btn btn-info">Ver Más.</a>
            </div>
            <div class="col-md-4">
                <img src="../../img/23.jpg" width="300" height="300" class="card-img-top">
            </div>
        </div>
        </br>
        <div class="row featurette">
            <div class="col-md-8">
                <h1 class="featurette-heading">David Tamal</h1>
                <h2 class="featurette-heading">Client</h2>
                <p class="lead">Expert administrator in attention to lawyers, 24 hours a day, 7 days a week. We provide the highest quality threads to the whole country.</p>
                <a href="Usuario.html" class="btn btn-info">Ver Más.</a>
            </div>
            <div class="col-md-4">
                <img src="../../img/24.jpg" width="300" height="300" class="card-img-top">
            </div>
        </div>
    </div>
</div>
