    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
      ...
      <div class="btn-group dropleft">
        ...
        <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
          ...
          <a class="dropdown-item" href="Cliente.jsp">ConfiguraciÛn</a>
          <a class="dropdown-item" href="../../assets/Index.jsp">Cerrar sesiÛn</a>
        </div>
      </nav>
    </div>
  </nav>
...
<div class="container">
  <div class="row featurette">
    <div class="col-md-6 order-md-2">
      ...
      <h6 href="producto.jsp" class="lead">este tipo de hilo sirve para cualquier tipo de costura pero es muy aconsejado para coser a mano, ya que es suave y f√°cil de sacar y romper.</h6>
      <div class="col-6 col-md">
      <a href="producto.jsp" class="badge badge-info">Destacado</a>
    </div>
  </div>
  <div class="col-md-2 order-md-4">
    <h3 class="text-right" class="featurette-heading">$8.000</h3>
    <a href="producto.jsp" style="float:right;" class="btn btn-primary btn-lg" role="button">Ver M·s.</a>
  </div>
  ...
  <div class="row featurette">
    <div class="col-md-6 order-md-2">
      ...
      <h6 href="producto.jsp" class="lead"> usado para coser seda y otras telas delicadas ofrece una variedad crom√°tica muy limitada. Ideal para bordados. Su precio es m√°s elevado que el resto.</h6>
      <div class="col-6 col-md">
      <a href="producto.jsp" class="badge badge-info">Destacado</a>
    </div>
  </div>
  ...
  <div class="row featurette">
    <div class="col-md-6 order-md-2">
      ...
      <h6 href="producto.jsp" class="lead">el√°sticos y por norma general fabricados con poli√©ster. Existen modelos tambi√©n de algod√≥n y fibra sint√©tica. Este tipo es de los m√°s resistentes para todo tipo de telas.</h6>
      <div class="col-6 col-md">
      <a href="producto.jsp" class="badge badge-info">Destacado</a>
    </div>
  </div>
  ...
  <div class="row featurette">
    <div class="col-md-6 order-md-2">
      ...
      <h6 href="producto.jsp" class="lead">este tipo de hilo es ideal para coser lana, algod√≥n y tiene un tono brillante. Sirven para coser tanto a m√°quina como a mano. Este tipo de hilo es mucho m√°s resistente a los lavados y planchados.</h6>
      <div class="col-6 col-md">
      <a href="producto.jsp" class="badge badge-info">Destacado</a>
    </div>
  </div>
  ...
  <div class="row featurette">
    <div class="col-md-6 order-md-2">
      ...
      <h6 href="producto.jsp" class="lead">Hilo de alta calidad para limpiar los dientes.</h6>
      <div class="col-6 col-md">
      <a href="producto.jsp" class="badge badge-info">Destacado</a>
    </div>
  </div>
