							...
							<h1>
								Tabla Proveedores
                                                ...
                                                <div class="container">
                                                    ...
                                                    <a class="btn btn-primary  btn-sm  " href="ControladorProveedor?accion=add">Agregar Nuevo Proveedor</a>
                                                    ...
                                                    <div>
                                                        <table id="dynamic-table" class="table table-striped table-bordered table-hover">
                                                            <thead class="text-center">
                                                                <tr>
                                                                    <th class="text-center hidden-400">ID Empresa</th>
                                                                    <th class="text-center hidden-400">Nit</th>
                                                                    <th class="text-center hidden-400">Razon Social</th>
                                                                    <th class="text-center hidden-400">Telefono</th>
                                                                    <th class="text-center hidden-400">Email</th>
                                                                    <th class="text-center hidden-400">Direccion</th>
                                                            ...
                                                            <tbody>
                                                                <tr>
                                                                    <td class="text-center"><%= pro.getId_empresa()%></td>
                                                                    <td class="text-center"><%= pro.getNit() %></td>
                                                                    <td class="text-center"><%= pro.getRazon_social() %></td>
                                                                    <td class="text-center"><%= pro.getTelefono() %></td>
                                                                    <td class="text-center"><%= pro.getEmail() %></td>
                                                                    <td class="text-center"><%= pro.getDireccion() %></td>
                                                                    <td class="text-center"><%= pro.getCiudad() %></td>

                                                                    <td class="text-center">
                                                                        <a class="btn btn-warning ace-icon fa fa-pencil btn-xs bigger" href="ControladorProveedor?accion=editar&id_empresa=<%= pro.getId_empresa()%>">Editar</a>
                                                                        <a class="btn btn-danger ace-icon fa fa-trash-o btn-xs bigger" href="ControladorProveedor?accion=eliminar&id_empresa=<%= pro.getId_empresa()%>">Remover</a>
                                                                    </td>
                                                                </tr>
                                                                <%}%>
                                                            </tbody>
