<%-- 
    Document   : edit
    Created on : 1/12/2019, 07:13:20 PM
    Author     : SAM
--%>
								...
								Editar Rol
                                                ...
                                                <div>
                                                    <%
                                                        ...
                                                        int id_ciudad = Integer.parseInt((String) request.getAttribute("idusu"));
                                                        Usuarios us = (Usuarios) dao.list(id_ciudad);
                                                    %>
                                                    
                                                    <form action="ControladorUsuarios">
                                                        Nombre: <br>
                                                        <input  type="text" name="txtnombre" value="<%= us.getNombre()%>"> <br>
                                                        Apellido:<br>
                                                        <input  type="text" name="txtapellido" value="<%= us.getApellido()%>" ><br>
                                                        Pass: <br>
                                                        <input  type="text" name="txtpass" value="<%= us.getPass()%>" ><br>
                                                        Correo: <br>
                                                        <input  type="text" name="txtcorreo" value="<%= us.getCorreo()%>" ><br>
                                                        Rol: <br>
                                                        <input  type="text" name="txtrol" value="<%= us.getRol()%>" ><br>
                                                        Tipo de Documento: <br>
                                                        <input  type="text" name="txttipo_documento" value="<%= us.getTipo_documento()%>" ><br>
                                                        Numero de Documento: <br>
                                                        <input  type="text" name="txtnumero_documento" value="<%= us.getNumero_documento()%>" ><br>
                                                        Telefono: <br>
                                                        <input  type="text" name="txttelefono" value="<%= us.getTelefono()%>" ><br>
                                                        Ciudad: <br>
                                                        <input  type="text" name="txtciudad" value="<%= us.getCiudad()%>" ><br>
                                                        
                                                        <input type="hidden" name="txtid_user" value="<%= us.getId_user()%>"><br>
                                                        <input class="btn btn-primary btn-sm" type="submit" name="accion" value="Actualizar"> 
                                                        <a class="btn btn-default btn-sm" href="ControladorUsuarios?accion=listar">Regresar</a>
                                                    </form>
                                                </div>
