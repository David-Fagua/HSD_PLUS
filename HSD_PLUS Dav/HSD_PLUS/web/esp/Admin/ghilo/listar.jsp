...
<%@page import="Modelo.Grosor_hilo"%>
<%@page import="java.util.List"%>
<%@page import="ModeloDAO.Grosor_hiloDAO"%>
...
<html lang="es">
	<head>
		...
		<meta charset="utf-8" />
		<title>Listar Grosor Hilo</title>
							...
							<h1>
								Tabla Grosor Hilo
                                                ...
                                                <div class="container">
                                                    ...
                                                    <a class="btn btn-primary  btn-sm  " href="ControladorGrosor_hilo?accion=add">Agregar Grosor Hilo</a>
                                                    ...
                                                    <div>
                                                        <table id="dynamic-table" class="table table-striped table-bordered table-hover">
                                                            <thead class="text-center">
                                                                <tr>
                                                                    <th class="text-center hidden-400">ID Grosor</th>
                                                                    <th class="text-center hidden-400">Medida</th>
                                                                    <th class="text-center hidden-400">Fecha de Aprobacion</th>
                                                                    <th class="text-center hidden-400">Acciones</th>
                                                                </tr>
                                                            </thead>
                                                            <%
                                                                Grosor_hiloDAO dao = new Grosor_hiloDAO();
                                                                List<Grosor_hilo> list = dao.listar();
                                                                Iterator<Grosor_hilo> iter = list.iterator();
                                                                Grosor_hilo gro = null;
                                                                while (iter.hasNext()) {
                                                                    gro = iter.next();
                                                            ...
                                                            <tbody>
                                                                <tr>
                                                                    <td class="text-center"><%= gro.getId_grosor() %></td>
                                                                    <td class="text-center"><%= gro.getMedida() %></td>
                                                                    <td class="text-center"><%= gro.getFecha_aprobacion()%></td>
                                                                    <td class="text-center">
                                                                        <a class="btn btn-warning ace-icon fa fa-pencil btn-xs bigger" href="ControladorGrosor_hilo?accion=editar&id_grosor=<%= gro.getId_grosor() %>">Editar</a>
                                                                        <a class="btn btn-danger ace-icon fa fa-trash-o btn-xs bigger" href="ControladorGrosor_hilo?accion=eliminar&id_grosor=<%= gro.getId_grosor() %>">Remover</a>
                                                                    </td>
                                                                </tr>
                                                                <%}%>
                                                            </tbody>
