...
<p>
  <button type="button" onclick="" class="btn btn-primary">Registrar Salida del Producto Vendido</button>
...
<center>
<p>
  <button type="button" class="btn btn-primary" >Consultar Historico de Registro de Ventas</button>
</p>
</center>
