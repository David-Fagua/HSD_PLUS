								...
								Editar Ciudades
                                                ...
                                                <div>
                                                    <%
                                                        ...
                                                        int id_ciudad = Integer.parseInt((String) request.getAttribute("idciu"));
                                                        Ciudad c = (Ciudad) dao.list(id_ciudad);
                                                    %>
                                                    ...
                                                    <form action="ControladorCiudad">
                                                        ...
                                                        <input type="hidden" name="txtid_ciudad" value="<%= c.getId_ciudad()%>"><br>
