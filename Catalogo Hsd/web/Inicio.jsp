  ...
  <nav class="navbar navbar-expand-lg fixed-top navbar-light bg-light">
   ...
   <button class="navbar-toggler" type="button" data-toggle="collapse" data-target="#navbarSupportedContent" aria-controls="navbarSupportedContent" aria-expanded="false" aria-label="Toggle navigation">
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
      ...
      <span><a style="float:left;" href="./ingles/start.html">Ingles</a></span>
      ...
      <div class="btn-group dropleft">
        ...
        <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
          <a class="dropdown-item" href="./esp/iniciosesion.html">Iniciar SesiÃ³n</a>
...
<div class="container">
  <div class="row featurette">
    <div class="col-md-6 order-md-2">
      ...
      <h6 href="Productos.html" class="lead">este tipo de hilo sirve para cualquier tipo de costura pero es muy aconsejado para coser a mano, ya que es suave y fÃ¡cil de sacar y romper.</h6>
  ...
  <div class="row featurette">
    <div class="col-md-6 order-md-2">
      ...
      <h6 href="Productos.html" class="lead"> usado para coser seda y otras telas delicadas ofrece una variedad cromÃ¡tica muy limitada. Ideal para bordados. Su precio es mÃ¡s elevado que el resto.</h6>
      <div class="col-6 col-md">
      <a href="#" class="badge badge-info">Destacado</a>
    </div>
  </div>
  ...
  <div class="row featurette">
    <div class="col-md-6 order-md-2">
      ...
      <h6 href="Productos.html" class="lead">elÃ¡sticos y por norma general fabricados con poliÃ©ster. Existen modelos tambiÃ©n de algodÃ³n y fibra sintÃ©tica. Este tipo es de los mÃ¡s resistentes para todo tipo de telas.</h6>
      <div class="col-6 col-md">
      <a href="#" class="badge badge-info">Destacado</a>
    </div>
  </div>
  ...
  <div class="row featurette">
    <div class="col-md-6 order-md-2">
      ...
      <h6 href="Productos.html" class="lead">este tipo de hilo es ideal para coser lana, algodÃ³n y tiene un tono brillante. Sirven para coser tanto a mÃ¡quina como a mano. Este tipo de hilo es mucho mÃ¡s resistente a los lavados y planchados.</h6>
      <div class="col-6 col-md">
      <a href="#" class="badge badge-info">Destacado</a>
    </div>
  </div>
